/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d826a6ed03adc29738a2777c7878dc9a)
// Runtime types generated with workerd@1.20250617.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		PROCOMPLY_BUCKET: R2Bucket;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* procomply */;
		ASSETS: Fetcher;
	}
}
