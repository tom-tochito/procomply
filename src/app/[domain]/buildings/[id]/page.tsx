      ...
      {activeTab === "tasks" && (
        <div className="space-y-6">
          ...
          <div className="flex space-x-4">
            ...
            >
              <span className="inline-flex items-center">
                <span className="size-2 bg-gray-500 rounded-full mr-2"></span>
                Future{" "}
                <span className="ml-1 text-xs bg-gray-200 px-1.5 rounded-full">
                  3
                </span>
            ...
            >
              <span className="inline-flex items-center">
                <span className="size-2 bg-purple-500 rounded-full mr-2"></span>
                On Hold{" "}
                <span className="ml-1 text-xs bg-gray-200 px-1.5 rounded-full">
                  0
                </span>
              ...
              <tbody>
                {filteredTasks.map((task) => (
                  <tr key={task.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm">{task.riskArea}</td>
                    <td className="px-4 py-3 text-sm">
                      <span
