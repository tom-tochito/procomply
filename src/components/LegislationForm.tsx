              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white shadow-xl transition-all">
                <div className="px-4 py-3 border-b border-gray-200">
                  <Dialog.Title className="text-base font-medium text-gray-900">
                    {editData ? "Edit Legislation" : "New Legislation"}
                  </Dialog.Title>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        placeholder="e.g. Approved Code of Practice L8 Legionnaires' disease"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g. http://www.hse.gov.uk/pubns/priced/l8.pdf"
                      />
                    </div>
                  </div>
