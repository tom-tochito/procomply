    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(
        (building) =>
          ...
          (building.data && JSON.stringify(building.data).toLowerCase().includes(term))
      );
    }
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 ${viewMode === "cards" ? "text-[#7600FF]" : "text-gray-400"}`}
            >
            ...
            <button
              ...
              className={`p-2 ${viewMode === "table" ? "text-[#7600FF]" : "text-gray-400"}`}
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
